...
- 本项目仅供个人学习、测试、内部知识整理和处理已获授权的内容使用。
- 禁止用于非法营利、侵犯版权、未经授权抓取、批量搬运、二次分发受保护内容、侵犯隐私、账号滥用或其他损害平台、作者、组织及第三方权益的行为。
- 使用者需自行遵守所在地法律法规、平台服务协议、版权规则、隐私政策及所在组织的内部合规要求。
...
- 需要像素级还原网页视觉布局。
- 需要替代人工做版权、授权或内容合规判断。
- 需要处理无明确来源、无访问权限或授权状态不清晰的内容。
- 需要大规模自动化采集、监控或批量同步网页内容。
- 需要自动处理验证码、MFA、账号切换、付费墙或权限审批流程。
